...
To change the mod's settings, edit the file `BepInEx/config/Azumatt.AzuClock.cfg` (created after running the game once
with this mod) using a text editor.
...
2. **Open the Mod Manager and search for "AzuClock" under the Online
